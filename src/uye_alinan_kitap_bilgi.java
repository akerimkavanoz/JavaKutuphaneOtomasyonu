...
public class uye_alinan_kitap_bilgi extends javax.swing.JFrame {

    public kitap gelen;
    String uyeid;
    public uye_alinan_kitap_bilgi(kitap al, String id) {
        initComponents();
        gelen = new kitap();
        gelen = al;
        uyeid = id;
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(kitap_barkod_no, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
